...
import { Home, ClipboardList, PlusCircle, Wallet, MoreHorizontal } from 'lucide-react'
import { useState } from 'react'

const navItems = [
  { icon: Home, label: '홈', id: 'home' },
  { icon: ClipboardList, label: '수거내역', id: 'history' },
  { icon: PlusCircle, label: '수거신청', id: 'request', isCenter: true },
  { icon: Wallet, label: '정산', id: 'settlement' },
  { icon: MoreHorizontal, label: '더보기', id: 'more' },
]
